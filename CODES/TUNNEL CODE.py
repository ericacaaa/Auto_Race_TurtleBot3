...
from std_msgs.msg import UInt8, Float64, String, Bool
...
class DetectSign():
    ...
    def cbFindTrafficSign(self, image_msg):
        ...
        if self.is_saw_tunnel == True and self.counter == 2:
            ...
            # self.move_fn(0.55, "forward")
            self.move_fn(0.9, "forward")
            # self.turn_fn(5, "left")
            rospy.loginfo("[Tunnel] MOTION...END")
    ...
    def fnPubGoalPose(self):
        ...
        goalPoseStamped.pose.position.x = 4.85
        goalPoseStamped.pose.position.y = 7.3
        goalPoseStamped.pose.position.z = 0.0

        goalPoseStamped.pose.orientation.x = 0.0
        goalPoseStamped.pose.orientation.y = 0.0
        goalPoseStamped.pose.orientation.z = 0.8112
        goalPoseStamped.pose.orientation.w = 0.5847
