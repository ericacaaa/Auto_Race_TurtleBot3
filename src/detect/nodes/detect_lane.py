...
class DetectLane():
    ...
    def make_lane(self, cv_image, white_fraction, yellow_fraction):
        ...
        # rospy.loginfo("whitelane reliability")
        # rospy.loginfo(self.reliability_white_line)
        # rospy.loginfo("yellowlane reliability")
        # rospy.loginfo(self.reliability_yellow_line)
        # rospy.loginfo("---------------------------")
